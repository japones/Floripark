...
public class CadastroBanco extends javax.swing.JDialog {

    private Banco bancoSelecionado;
    private Usuario ul;

    public CadastroBanco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public CadastroBanco(java.awt.Frame parent, boolean modal, Usuario usuarioLogado) {
        this(parent, modal);
        ul = usuarioLogado;
        btnExcluir.setVisible(false);
    }

    public CadastroBanco(java.awt.Frame parent, boolean modal, Usuario usuarioLogado, Banco banco) {
        this(parent, modal);
        bancoSelecionado = banco;
        ul = usuarioLogado;
        tfCodigo.setText(banco.getId().toString());
        tfNome.setText(banco.getNome());
        tfUsuarioInclusao.setText(bancoSelecionado.getUsuarioinclusao().getNome());
        tfDataInclusao.setText(bancoSelecionado.getDatainclusao().toString());
        if (bancoSelecionado.getUsuarioalteracao() != null) {
            tfUsuarioAlteracao.setText(bancoSelecionado.getUsuarioalteracao().getNome());
            tfDataAlteracao.setText(bancoSelecionado.getDataalteracao().toString());
        } else {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (bancoSelecionado != null) {
            Integer id = bancoSelecionado.getId();
            String nome = tfNome.getText();
            Date dataInclusao = bancoSelecionado.getDatainclusao();
            Usuario usuarioInclusao = bancoSelecionado.getUsuarioinclusao();
            try {
                Boolean alterar = ServiceFactory.getBancoService().alterarBanco(id, nome, ul, dataInclusao, usuarioInclusao);
                if (alterar == true) {
            ...
            String nome = tfNome.getText();
            try {
                Boolean incluir = ServiceFactory.getBancoService().inserirBanco(codigo, nome, ul);
                if (incluir == true) {
                    dispose();
                }
            } catch (Exception ex) {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        try {
            ServiceFactory.getBancoService().excluirBanco(bancoSelecionado.getId());
            dispose();
        } catch (Exception ex) {
            Logger.getLogger(CadastroBanco.class.getName()).log(Level.SEVERE, null, ex);
        }
